...
public class CsvDataFactory {
	private static final Logger logger = LogManager.getLogger(CsvDataFactory.class);
	...
	public CsvDataFactory(String csvName) {
		super();
	...
	public List<DataFlow> csvToData() throws CsvValidationException, IOException {

		URL fileUrl = CsvDataFactory.class.getClassLoader().getResource(csvName);
		...
		while ((nextLine = csvReader.readNext()) != null) {
			if (nextLine != null) {
				// Verifying the read data here System.out.println(Arrays.toString(nextLine));
